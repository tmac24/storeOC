...
//    DCStudent *student = [[DCStudent alloc] init];
//    student.nickname = @"fswerew";
//    student.sex = @"男";
//    student.birthDay = @"1996-02-10";
//    student.username = @"qq-w923740293";
//    student.defaultAddress = @"江苏 苏州吴中";
//    student.like = @"江苏 苏州吴中";
//
//    dispatch_async(dispatch_get_global_queue(0, 0), ^{//异步保存
//        [student save];
//    });
